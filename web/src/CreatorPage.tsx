      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "0 2rem 3rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {(["bronze", "silver", "gold"] as Tier[]).map((tier) => {
            ...
            return (
              <div key={tier} style={{
                border: `1px solid ${isCurrent ? config.color : config.color + "33"}`,
                ...
                <button className="btn-primary" style={{
                  width: "100%", background: isCurrent ? "#1a1a1a" : config.color,
        ...
        {txMsg && (
          <div style={{
            padding: "1rem", background: txMsg.startsWith("error:") ? "#1a0808" : "#081a08",
        ...
        {/* Partage */}
        <div style={{
          marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgba(255,255,255,0.06)",
